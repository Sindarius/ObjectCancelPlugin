...
export default class {
    ...
    constructor(el, clientWidth, clientHeight) {
        ...
        this.bedSvg = this.zoomArea.append('rect');
    ...
    updateViewBox(x, y) {
        this.svg.attr('viewBox', `20 20 ${x.max - x.min} ${y.max - y.min}`)
    }

    updateRect(el, x, y, stroke, fill) {
        el.attr('x', this.x(x.min))
            .attr('y', this.y(y.max))
